		...
		<div class="wrap">
			<h1 style="display:flex;align-items:center;gap:12px;flex-wrap:wrap;">
				...
				<span style="font-size:13px;font-weight:400;margin-left:4px;">
					...
					<span style="color:#c3c4c7;margin:0 6px;">·</span>
					<a href="https://github.com/catalisidev/cetus-media-optimizer/issues" target="_blank" rel="noopener" style="text-decoration:none;color:#646970;" title="<?php esc_attr_e( 'GitHub Issues', 'cetus-media-optimizer' ); ?>">
						<?php esc_html_e( 'GitHub', 'cetus-media-optimizer' ); ?>
					</a>
					<span style="color:#c3c4c7;margin:0 6px;">·</span>
					<a href="<?php echo esc_url( 'mailto:support@catalisi.dev?subject=' . rawurlencode( 'Cetus Image Converter & AI Alt Text v' . CETUS_MO_VERSION . ' – Support – ' . ( wp_parse_url( home_url(), PHP_URL_HOST ) ?? '' ) ) ); ?>" style="text-decoration:none;color:#646970;" title="<?php esc_attr_e( 'Email support', 'cetus-media-optimizer' ); ?>">
			...
			<div style="display:flex;align-items:flex-start;gap:16px;flex-wrap:wrap;">
				...
				<div style="flex:1;min-width:200px;">
					...
					<p style="margin:0 0 14px;color:#50575e;font-size:13px;">
						<?php esc_html_e( 'Cetus Image Converter & AI Alt Text is 100% free and open source. If it is optimizing your media library and improving your Core Web Vitals scores, support Catalisi\'s development by leaving a 5-star review on WordPress.org.', 'cetus-media-optimizer' ); ?>
					</p>
